...
export interface FrameProps extends ButtonHTMLAttributes<HTMLDivElement> {
   /**
    * Max container width
    */
   maxWidth: MaxWidth;
...
export const Frame: React.FC<FrameProps> = ({children, maxWidth, backgroundColor, ...props}) => (
   <StyledFrame maxWidth={maxWidth} backgroundColor={backgroundColor} {...props}>
